...
const DEFINITIONS := {
    &"spikes": {"name": "Pointes", "forge_level": 0, "cost": 25, "damage": 35, "cooldown": 1.5, "effect": &"vulnerable", "duration": 1.5, "strength": 1.0, "color": Color("ed6a5a")},
    ...
    &"fire_rune": {"name": "Rune incendiaire", "forge_level": 2, "cost": 35, "damage": 30, "cooldown": 0.9, "effect": &"burning", "duration": 2.0, "strength": 1.0, "color": Color("ff8a3d")},
    ...
    &"soul_mine": {"name": "Mine d'âme", "forge_level": 4, "cost": 45, "damage": 70, "cooldown": 4.0, "effect": &"frightened", "duration": 2.5, "strength": 1.0, "color": Color("c77dff")},
